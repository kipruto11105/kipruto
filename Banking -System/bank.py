...
class BankAcc:
    ...
    def withdraw(self,amount):
        if amount>self.balance:
            return f"Your balance is {self.balance} and You cant't withdraw  {amount} it is below minimum"
        else:
            self.balance-=amount
            now=datetime.now()
            transaction={
    ...
    def borrow(self,amount):
        ...
        if amount <0:
            ...
            self.statement.append(transaction)
            return f"Congratulation {self.name} you have received a loan of {amount} your loan balance is {loan} and your account balance is {self.balance}"
    ...
    def transfer(self,account,amount):
        ...
        if amount<0:
            ...
            return f"you have transferred {amount} to acc {account} your balance is {self.balance -account}"    
